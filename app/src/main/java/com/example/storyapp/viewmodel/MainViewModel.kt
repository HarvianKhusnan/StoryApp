...
class MainViewModel(private val preferences: UserPreferences, application: Application, private val storyRepo: RepositoryStory) : AndroidViewModel(application)
{
    ...
    fun pagingStory() : LiveData<PagingData<Story>>{
        return storyRepo.story().cachedIn(viewModelScope)
    }
}